...
\newcommand{\validate}[2]{%
  \ifnum\checkvalid{#1}{#2}=1%
...
\newcommand{\validateint}[2]{%
  \ifnum\fpeval{abs((#1) - (#2)) < 1}=1%
    {\color{green!60!black}\textbf{\numint{#1}}}%
  \else%
    \global\allvalidationspassedfalse%
