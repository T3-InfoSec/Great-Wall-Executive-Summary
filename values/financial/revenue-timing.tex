...
% (Totals equal subscription revenue in protocol-first scope; use actualSubRevenueYearX directly)

%% ================= Actual Net Income/Loss =================
\newcommand{\actualNetIncomeYearOne}{\fpeval{round(\actualSubRevenueYearOne - \totalOpexYearOne - \marketingBudgetYearOne, 0)}}
\newcommand{\actualNetIncomeYearTwo}{\fpeval{round(\actualSubRevenueYearTwo - \totalOpexYearTwo - \marketingBudgetYearTwo, 0)}}
\newcommand{\actualNetIncomeYearThree}{\fpeval{round(\actualSubRevenueYearThree - \totalOpexYearThree - \marketingBudgetYearThree, 0)}}
