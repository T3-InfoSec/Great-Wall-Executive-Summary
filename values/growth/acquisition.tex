...
% Subscription payback period in months
\newcommand{\subPaybackMonths}{\fpeval{round((\cacDigital - \merchOffsetSubsCalc) / \subMonthlyGrossProfit, 1)}}

% Hardware payback period (immediate due to one-time purchase)
\newcommand{\hwPaybackMonths}{0}
